...
return [
    ...
    // Search
    'search_results' => 'Итоги поисковой системы',
    'search_total_results_found' => 'Найден :count результат|Найдено :count результата|Найдено :count результатов',
    'search_clear' => 'Очистить поиск',
    'search_no_pages' => 'Поисковая система не нашла страницы, соответствующие данному поиску',
    ...
    'books_create' => 'Создать новую КНИЖКУ',
    'books_delete' => 'Удалить КНИЖКУ',
    'books_delete_named' => 'Удалить эту КНИЖКУ :bookName',
